...
variable "images" {
  ...
  default     = [ "almalinux8o", "almalinux9o", "almalinux10o", "amazonlinux2o", "amazonlinux2023o", "centos7o", "libertylinux9o", "openeuler2403o", "opensuse156o", "opensuse160o", "tumbleweedo", "oraclelinux9o", "oraclelinux10o", "rocky8o", "rocky9o", "rocky10o", "sles12sp5o", "sles15sp4o", "sles15sp5o", "sles15sp6o", "sles15sp7o", "sles160o", "ubuntu2204o", "ubuntu2404o", "ubuntu2604o" ]
  type        = set(string)
}
...
variable "product_version" {
  description = "One of: 4.3-nightly, 4.3-released, 4.3-VM-nightly, 4.3-VM-released, 5.1-nightly, 5.1-released, 5.2-nightly, 5.2-released, head, head-staging, uyuni-master, uyuni-released"
  type        = string
  default     = ""
}
