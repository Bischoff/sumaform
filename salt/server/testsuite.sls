...
{% set products_using_new_cobbler_version = ["uyuni-master", "uyuni-released", "head", "head-staging", "4.3-released", "4.3-nightly", "4.3-VM-nightly", "4.3-VM-released" ] %}
...
{% set products_to_use_salt_bundle = ["uyuni-master", "4.3-nightly", "4.3-released", "4.3-VM-nightly", "4.3-VM-released"] %}
