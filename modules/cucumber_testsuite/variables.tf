...
variable "images" {
  ...
  default     = ["centos7o", "opensuse156o", "opensuse160o", "slemicro55o", "slmicro60o", "slmicro61o", "slmicro62o", "rocky8o", "rocky9o", "sles12sp5o", "sles15sp4o", "sles15sp5o", "sles15sp6o", "sles15sp7o", "ubuntu2204o", "ubuntu2404o", "ubuntu2604o", "suma43VM-ign"]
}
...
variable "kubernetes_storage_class" {
  description = "StorageClass name used by the Kubernetes server PVCs. Leave null to use local-path for the local-path backend or the cluster default for the external backend."
  type        = string
  default     = null
}
...
variable "kubernetes_var_pgsql_host_path" {
  description = "Host path used by the static var-pgsql18 PersistentVolume."
  default     = null
}
